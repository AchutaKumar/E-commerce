...
SECRET_KEY = 'django-insecure-4is0*-ld^bamqmu7j#as0atbk8cbw*9fg99rqfg!&qcvu_y$^$'
...
# Database
# Use MySQL if env variables are provided, otherwise fallback to SQLite3 for seamless deployment
